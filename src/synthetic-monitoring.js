...
async function main() {
    ...
    Promise.all(tests)
                 .then((result) => {console.log("SUCCESS"); trackSelfAvailabilityEvent(successMonitoringEvent, startTime);})
                 .catch((error) => {console.error("FAILURE"); trackSelfAvailabilityEvent(failedMonitoringEvent, startTime);})
};
