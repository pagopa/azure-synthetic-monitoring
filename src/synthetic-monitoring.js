    ...
    for await (const tableConfiguration of tableEntities) {
        ...
        try{
            ...
            let monitoringConfiguration = {
                ...
                bodyCompareStrategy: !statics.isNull(tableConfiguration['bodyCompareStrategy']) ? JSON.parse(tableConfiguration['expectedCodes']) : null,
                expectedBody: !statics.isNull(tableConfiguration['expectedBody']) ? JSON.parse(tableConfiguration['expectedCodes']) : null,
